...
class SeminarReminder7d extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        ...
        if ($count === 1) {
            ...
            $subject = "Lembrete: {$seminar->typeName()} na próxima semana!";
        } else {
            $desc = SeminarPluralDescriptor::for($this->seminars);
            $subject = "Lembrete: {$count} {$desc->noun} na próxima semana!";
        }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            markdown: 'emails.seminar-reminder-7d',
            with: [
    ...
    protected function refId(): string
    {
        ...
        return 'seminar-reminder-7d:'.$this->user->id.':'.$seminarIds.':'.now()->format('Ymd');
    }
}
