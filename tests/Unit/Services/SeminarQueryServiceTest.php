...
it('eager-loads list relations and registrations count on a query', function (): void {
...
it('eager-loads detail relations and registrations count on a query', function (): void {
