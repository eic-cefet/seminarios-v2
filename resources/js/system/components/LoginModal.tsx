        ...
        >
            <Dialog.Portal>
                ...
                <Dialog.Content
                    ...
                    /* v8 ignore start -- Radix outside-interaction handlers are not invoked by JSDOM; behaviour covered end-to-end by the "stays open when user presses escape or clicks outside" test */
